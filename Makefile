...
SALES_OBJS := sales_associate.o sales_creation_window.o sales_associate_repo.o
...
$(OBJ_DIR)/sales_associate.o: sales_associate.cpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
$(OBJ_DIR)/sales_associate_repo.o: sales_associate_repo.cpp sales_associate.hpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
