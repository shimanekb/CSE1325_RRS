...
SALES_OBJS := sales_associate.o sales_creation_window.o sales_associate_repo.o sales_controller.o
...
$(OBJ_DIR)/rrs_manager_view.o: rrs_manager_view.cpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
$(OBJ_DIR)/rrs_main_window.o: rrs_main_window.cpp part_creation_window.hpp rrs_window.hpp robot_browser.hpp part_controller.hpp robot_controller.hpp part_browser.hpp order_creation_window.hpp order_browser.hpp customer_controller.hpp customer_creation_window.hpp sales_creation_window.hpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
...
$(OBJ_DIR)/sales_associate.o: sales_associate.cpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
$(OBJ_DIR)/sales_associate_repo.o: sales_associate_repo.cpp sales_associate.hpp rrs_error.hpp
	$(CXX) $(CXXFLAGS) $(INC) -c $< -o $@ 
